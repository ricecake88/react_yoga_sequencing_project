...
class SeqContainerCOPY extends Component {
    ...
    render() {
        console.log(">>>SeqContainerCOPY ->render()")
...
export default connect(mapStateToProps, mapDispatchToProps)(SeqContainerCOPY);